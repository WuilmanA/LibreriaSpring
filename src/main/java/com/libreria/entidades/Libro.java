...
public class Libro {
    ...
    public String toString() {
        return "Libro{" + "id=" + id + ", isbn=" + isbn + ", titulo=" + titulo + ", anio=" + anio + ", ejemplares=" + ejemplares + ", ejemplaresPrestados=" + ejemplaresPrestados + ", Restantes=" + Restantes + ", alta=" + alta + ", autor=" + autor + ", editorial=" + editorial + ", fecAlta=" + fecAlta + '}';
    }
